...
class AjaxCore
{
    ...
    */
    function setOutputHeaders ($oheaders)
    {
        if (is_bool($oheaders))
    ...
    */
    function triggerOnEmpty ($element, $elementName, $method)
    {
        if (empty($element))
    ...
    */
    function bindInline ($bindto, $params = "", $id = "")
    {
    ...
    * @return string JavaScript inline code to handle the binding.
    */
    function bindTimerInline ($bindto, $timername, $timerms, $params = "", $id = "")
    {
    ...
    * @return string JavaScript inline code to handle the binding.
    */
    function bindPeriodicalTimerInline ($bindto, $timername, $timerms, $params = "", $id = "")
    {
    ...
    */
    function htmlWindowTitle ($string)
    {
